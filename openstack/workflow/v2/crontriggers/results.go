...
type CronTrigger struct {
	...
	// WorkflowInput contains the workflow input values in a JSON stringified object.
...
func (e CronTriggerPage) IsEmpty() (bool, error) {
	exec, err := ExtractCronTriggers(e)
	return len(exec) == 0, err
}

// NextPageURL finds the next page URL in a page in order to navigate to the next page of results.
func (e CronTriggerPage) NextPageURL() (string, error) {
	var s struct {
